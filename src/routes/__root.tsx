...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Free image, PDF, and audio tools built for browser-based processing. No uploads, no login, no backend file handling." },
      { name: "robots", content: "index,follow" },
      { name: "author", content: "Creator Kit" },
      { name: "theme-color", content: "#090b10" },
      { name: "application-name", content: "CreatorKit Tools" },
      { name: "apple-mobile-web-app-title", content: "CreatorKit" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { property: "og:title", content: "CreatorKitTools - Free Browser-Based File Tools" },
      { property: "og:description", content: "Browser-only creator tools: convert, compress, trim, resize, and download without uploading files." },
      { property: "og:image", content: "https://creatorkittools.com/favicon-512x512.png" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@CreatorKit" },
      { name: "twitter:image", content: "https://creatorkittools.com/favicon-512x512.png" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      { rel: "icon", type: "image/png", sizes: "192x192", href: "/android-chrome-192x192.png?v=2" },
      { rel: "icon", type: "image/png", sizes: "512x512", href: "/android-chrome-512x512.png?v=2" },
